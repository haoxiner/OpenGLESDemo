package name.haoxin.demo.util.objmodelloader;
...
public class Parse {
    ...
    public Parse(BuilderInterface builder, AssetManager assetManager, String filename) throws FileNotFoundException, IOException {
    ...
    private void parseObjFile(String objFilename) throws FileNotFoundException, IOException {
        int lineCount = 0;
        InputStream inputStream = assetManager.open(objFilename);
